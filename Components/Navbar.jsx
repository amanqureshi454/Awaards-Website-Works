...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scrollThreshold = (viewportHeight * 90) / 100;
    ...
    <>
      <div
        className={`lg:px-16 lg:py-8 xl:py-10 py-10 px-4
         w-full flex justify-between items-center fixed ${
           isScroll ? "z-[60]" : "z-[80]"
         } menu-large  top-0`}
      >
        <div className="logo">
        ...
        <div className="links lg:flex md:flex items-center overflow-hidden ">
          <div className="overflow-hidden">
            <div className="wrap" ref={links}>
              <Link
                ...
                } lg:text-[1.1vw]  md:text-[1.8vw] text-xl font-normal uppercase lg:px-5 py-2 mx-2 font-Neuve centro`}
              >
                Projects
              </Link>
              <Link
          ...
          <div className="close-img" onClick={linkHandler}>
            <img
              ...
              ref={closeicon}
              src={`/imgs/icon-nav-plus-${isScroll ? "white" : "black"}.svg`}
              alt=""
              style={{
      ...
      <MobileMenu bgColor="#F5E41B" plus="black" textColor="#000" />
    </>
  );
};
