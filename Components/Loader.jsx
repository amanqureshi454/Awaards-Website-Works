...
const Loader = () => {
  ...
  return (
    <div className="loader relative z-[82] h-screen">
      <div
        ref={element1}
        className="first-loader bg-[#F5E41B] h-screen w-full absolute z-40"
      ></div>
      ...
      <div className="video relative z-10">
        <video
          ...
          muted
          style={{ display: "none" }}
          className="w-full lg:h-full md:h-full h-screen object-cover"
          src="/imgs/4_version1_200911_024121.mp4"
        />
        <div className="lg:px-16 lg:py-8 menu-large lg:top-3 absolute z-10 py-8 bg-transparent w-full flex justify-between items-center">
          ...
          <nav className="links flex items-center overflow-hidden">
            <div className="overflow-hidden">
              <div className="wrap">
                <a
                  href="/"
                  className="link-inside text-[#fff] lg:text-[1.1vw]  md:text-[1.8vw] text-xl font-normal uppercase lg:px-5 py-2 mx-2 font-Neuve "
                >
                  Projects
                </a>
                <a
            ...
            <div className="close-img">
              <img
                className="w-8 h-8 ml-10 cursor-pointer -rotate-45"
        ...
        <div className="absolute h-screen pt-8 inset-0 flex justify-center items-center">
          <h1
            className="lg:text-[6vw] text-[2.5rem] md:text-[7vw] hero-text w-full text-[#fff] font-extralight font-[Works]  pb-14 md:pt-20 pt-14 text-center"
            style={{
              lineHeight: ".9em",
              fontStyle: "italic",
            }}
          >
            We are a <span>CREATIVE</span> studio <br />
            <span>DEDICATED</span> to <span>CULTURAL</span>{" "}
            <span>ADVANCEMENT</span> through <br />
      ...
      <div
        ref={element2}
        className="first-loader bg-[#000] h-screen w-full absolute z-30"
      ></div>
    </div>
  );
};
